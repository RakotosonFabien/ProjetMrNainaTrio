...
public class Inscription extends HttpServlet {
    ...
    */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //processRequest(request, response);
        //request.setAttribute("classe", "Inscription");
        ...
        try{
            ...
            Date naissance = Helper1.stringsToDate(request.getParameter("annee"), request.getParameter("mois"), request.getParameter("jour"));
            ...
            request.setAttribute("attribut", "Test");
            request.setAttribute("message", "reussite");
            dispat = request.getRequestDispatcher("/gestionErreur?classe=Inscription");
            dispat.forward(request,response); 
        }
        catch(Exception e){
            //out.println("Exception lesy eh");
